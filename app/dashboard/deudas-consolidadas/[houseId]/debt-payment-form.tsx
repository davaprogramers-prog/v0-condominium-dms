        ...
        <>
          ...
          <div>
            ...
            <input
              ...
              disabled={loading}
              className="sr-only"
              id="consolidated-payment-file-upload"
            />
            <input
              type="file"
              accept="image/*"
              ...
              disabled={loading}
              className="sr-only"
              id="consolidated-payment-camera-upload"
            />
            <div className="grid grid-cols-2 gap-2">
              <label htmlFor="consolidated-payment-camera-upload" className="flex min-h-24 cursor-pointer flex-col items-center justify-center gap-2 rounded-lg border-2 border-dashed p-3 text-center transition hover:bg-muted/50">
              ...
              <label htmlFor="consolidated-payment-file-upload" className="flex min-h-24 cursor-pointer flex-col items-center justify-center gap-2 rounded-lg border-2 border-dashed p-3 text-center transition hover:bg-muted/50">
