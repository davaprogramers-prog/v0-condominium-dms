      ...
      >
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-3">
            <h3 className="font-semibold text-sm" style={{ color: theme.text_color }}>
              Desglose por Tipo
            </h3>
            ...
            <div className="space-y-2">
              ...
              {deuda.commonExpenses > 0 && (
                <div className="flex justify-between items-center p-3 rounded bg-opacity-20" style={{ backgroundColor: "#3b82f6" }}>
                  <span style={{ color: theme.text_color }}>Gastos Comunes</span>
              ...
              {deuda.variableExpenses > 0 && (
                <div className="flex justify-between items-center p-3 rounded bg-opacity-20" style={{ backgroundColor: "#8b5cf6" }}>
                  <span style={{ color: theme.text_color }}>Gastos Variables</span>
                </div>
              )}
              ...
              {deuda.finesAmount > 0 && (
                <div className="flex justify-between items-center p-3 rounded bg-opacity-20" style={{ backgroundColor: "#f59e0b" }}>
                  <span style={{ color: theme.text_color }}>Multas (CLP)</span>
                </div>
              )}
              ...
              {deuda.finesUF > 0 && (
                <div className="flex justify-between items-center p-3 rounded bg-opacity-20" style={{ backgroundColor: "#06b6d4" }}>
                  <span style={{ color: theme.text_color }}>Multas (UF)</span>
          ...
          <div className="border-t pt-4" style={{ borderColor: theme.border_color }}>
            ...
            <p className="text-xs mt-4" style={{ color: theme.text_color, opacity: 0.6 }}>
