    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
        <DialogHeader>
          ...
          <DialogDescription style={{ color: theme.textColor, opacity: 0.7 }}>
        ...
        <div className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              {deuda.commonExpenses > 0 && (
                <div className="flex justify-between items-center p-3 rounded bg-opacity-20" style={{ backgroundColor: "#3b82f6" }}>
                  <span style={{ color: theme.textColor }}>Gastos Comunes</span>
              ...
              {deuda.variableExpenses > 0 && (
                <div className="flex justify-between items-center p-3 rounded bg-opacity-20" style={{ backgroundColor: "#8b5cf6" }}>
                  <span style={{ color: theme.textColor }}>Gastos Variables</span>
                  <Badge className="bg-purple-600 text-white">
                    {formatCurrency(deuda.variableExpenses, currencySymbol)}
                  </Badge>
                </div>
              )}
              ...
              {deuda.finesAmount > 0 && (
                <div className="flex justify-between items-center p-3 rounded bg-opacity-20" style={{ backgroundColor: "#f59e0b" }}>
                  <span style={{ color: theme.textColor }}>Multas (CLP)</span>
                  <Badge className="bg-amber-600 text-white">
                    {formatCurrency(deuda.finesAmount, currencySymbol)}
                  </Badge>
                </div>
              )}
              ...
              {deuda.finesUF > 0 && (
                <div className="flex justify-between items-center p-3 rounded bg-opacity-20" style={{ backgroundColor: "#06b6d4" }}>
                  <span style={{ color: theme.textColor }}>Multas (UF)</span>
          ...
          <div className="border-t pt-4" style={{ borderColor: theme.borderColor }}>
            ...
            <p className="text-xs mt-4" style={{ color: theme.textColor, opacity: 0.6 }}>
